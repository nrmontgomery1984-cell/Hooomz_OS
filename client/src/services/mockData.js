...
export const workCategories = [
  ...
  { code: 'DM', name: 'Demo & Prep', color: '#EF4444', icon: 'Hammer', displayOrder: 2 },
  { code: 'FN', name: 'Foundation', color: '#A1A1AA', icon: 'Building', displayOrder: 3 },
  { code: 'FR', name: 'Framing', color: '#F59E0B', icon: 'Frame', displayOrder: 4 },
  { code: 'FS', name: 'Structural Framing', color: '#F59E0B', icon: 'Frame', displayOrder: 4 },
  { code: 'FI', name: 'Interior Framing', color: '#FBBF24', icon: 'Frame', displayOrder: 5 },
  { code: 'RF', name: 'Roofing', color: '#6366F1', icon: 'Home', displayOrder: 6 },
  { code: 'EX', name: 'Exterior', color: '#14B8A6', icon: 'Building2', displayOrder: 7 },
  { code: 'EE', name: 'Exterior Envelope', color: '#14B8A6', icon: 'Building2', displayOrder: 7 },
  { code: 'WD', name: 'Windows & Doors', color: '#06B6D4', icon: 'DoorOpen', displayOrder: 8 },
  { code: 'IN', name: 'Insulation', color: '#F97316', icon: 'Layers', displayOrder: 9 },
  { code: 'IA', name: 'Insulation & Air Sealing', color: '#F97316', icon: 'Layers', displayOrder: 9 },
  { code: 'EL', name: 'Electrical', color: '#EAB308', icon: 'Zap', displayOrder: 10 },
  { code: 'PL', name: 'Plumbing', color: '#3B82F6', icon: 'Droplets', displayOrder: 11 },
  { code: 'HV', name: 'HVAC', color: '#22C55E', icon: 'Wind', displayOrder: 12 },
  { code: 'DW', name: 'Drywall', color: '#A855F7', icon: 'Square', displayOrder: 13 },
  { code: 'PT', name: 'Painting', color: '#EC4899', icon: 'Paintbrush', displayOrder: 14 },
  { code: 'FL', name: 'Flooring', color: '#84CC16', icon: 'LayoutGrid', displayOrder: 15 },
  { code: 'TL', name: 'Tile', color: '#0EA5E9', icon: 'Grid3X3', displayOrder: 16 },
  { code: 'FC', name: 'Finish Carpentry', color: '#D946EF', icon: 'Hammer', displayOrder: 17 },
  { code: 'CB', name: 'Cabinetry', color: '#10B981', icon: 'Package', displayOrder: 18 },
  { code: 'CM', name: 'Cabinetry & Millwork', color: '#10B981', icon: 'Package', displayOrder: 18 },
  { code: 'CT', name: 'Countertops', color: '#8B5CF6', icon: 'Layers3', displayOrder: 19 },
  { code: 'SR', name: 'Stairs & Railings', color: '#78716C', icon: 'ArrowUpRight', displayOrder: 20 },
  { code: 'FX', name: 'Fixtures', color: '#0891B2', icon: 'Lightbulb', displayOrder: 21 },
  { code: 'EF', name: 'Exterior Finishes', color: '#14B8A6', icon: 'Building2', displayOrder: 22 },
  { code: 'FZ', name: 'Final Completion', color: '#64748B', icon: 'CheckCircle', displayOrder: 23 },
  { code: 'CL', name: 'Cleaning & Closeout', color: '#64748B', icon: 'Sparkles', displayOrder: 24 },
  { code: 'GN', name: 'General', color: '#71717A', icon: 'Package', displayOrder: 25 },
];
