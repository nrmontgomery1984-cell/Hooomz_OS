...
import { Home, Timer, User, Receipt, ClipboardList, Wrench } from 'lucide-react';
...
export function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 lg:hidden z-50 pb-[env(safe-area-inset-bottom)]">
