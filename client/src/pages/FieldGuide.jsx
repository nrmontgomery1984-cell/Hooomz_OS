  ...
  return (
    <div className="min-h-screen bg-white pb-16 lg:pb-0">
      <div className="px-4 lg:px-6 py-6">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-xl lg:text-2xl font-bold text-charcoal flex items-center gap-2">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
          <Card className="p-3">
            <div className="text-xl font-bold text-charcoal">{modules.length}</div>
            <div className="text-xs text-gray-500">Total Modules</div>
          </Card>
          <Card className="p-3">
            <div className="text-xl font-bold text-green-600">{completeCount}</div>
            <div className="text-xs text-gray-500">Ready to Study</div>
          </Card>
          <Card className="p-3">
            <div className="text-xl font-bold text-amber-600">{modules.length - completeCount}</div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="flex-1 sm:flex-none px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-charcoal"
            >
