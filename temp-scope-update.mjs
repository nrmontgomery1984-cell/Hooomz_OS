...
export function ScopeSummary({ scope, onViewFullScope }) {
  ...
  return (
    <Card className="p-4 h-full">
      ...
      {/* View Full Scope Button - Toggles expanded view */}
      <Button
...
const outputPath = 'D:/Hooomz_OS/client/src/components/dashboard/ScopeSummary.jsx';
fs.writeFileSync(outputPath, content);
console.log('ScopeSummary.jsx updated successfully');
